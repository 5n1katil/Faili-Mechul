        ...
        <View style={[styles.crossgridScroll, { marginHorizontal: 12 }]}>
          <View style={styles.crossgridRow}>
            <View style={[styles.crossgridCell, styles.crossgridCorner, { width: CELL, height: CELL }]}>
              <Text style={[styles.crossgridCornerText, { fontFamily: "DroidSerifRegular", fontSize: symFont }]}>↘</Text>
            </View>
            {colSymbols.map((sym, ci) => (
              <View key={ci} style={[styles.crossgridCell, styles.crossgridColHeader, { width: CELL, height: CELL }]}>
                <Text style={[styles.crossgridHeaderText, { fontFamily: "DroidSerifRegular", fontSize: symFont }]}>{sym}</Text>
              </View>
            ))}
          </View>
          {rowSymbols.map((rowSym, ri) => (
            <View key={ri} style={styles.crossgridRow}>
              <View style={[styles.crossgridCell, styles.crossgridRowHeader, { width: CELL, height: CELL }]}>
                <Text style={[styles.crossgridHeaderText, { fontFamily: "DroidSerifRegular", fontSize: symFont }]}>{rowSym}</Text>
              </View>
              {(cells[ri] ?? []).map((letter, ci) => (
                <View key={ci} style={[styles.crossgridCell, styles.crossgridDataCell, { width: CELL, height: CELL }]}>
                  <Text style={[styles.crossgridCellText, { fontFamily: "DroidSerifRegular", fontSize: letterFont }]}>{letter}</Text>
                </View>
              ))}
            </View>
          ))}
...
const styles = StyleSheet.create({
  ...
  scaleTitle: { fontFamily: "DroidSerifRegular", fontSize: 14, fontWeight: "700", color: "#D4A843", marginBottom: 2 },
  scaleSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", marginBottom: 4 },
  scalePurposeHint: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#6b7280", fontStyle: "italic", marginBottom: 8, lineHeight: 15 },
  scaleOffering: {
  ...
  scaleOfferingLabel: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#e2c97e", flex: 1 },
  scaleOfferingMark: { fontFamily: "DroidSerifRegular", fontSize: 10, color: "#8b91ad", fontStyle: "italic" },
  scaleAltars: { gap: 4 },
  scaleAltarBtn: {
    flexDirection: "row",
    alignItems: "center",
  ...
  scaleAltarText: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#9ca3af" },
  scaleAltarTextSelected: { color: "#D4A843", fontWeight: "600" },
  scaleAltarMark: { fontFamily: "DroidSerifRegular", fontSize: 10, color: "#6b7280", fontStyle: "italic" },
  // ── ForgeBellowsCycleBlock ──
  bellowsContainer: { gap: 6 },
  bellowsTitle: { fontFamily: "DroidSerifRegular", fontSize: 14, fontWeight: "700", color: "#f97316", marginBottom: 2 },
  bellowsSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", marginBottom: 4 },
  bellowsPurposeHint: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#6b7280", fontStyle: "italic", marginBottom: 8, lineHeight: 15 },
  bellowsCard: {
    flexDirection: "row",
    alignItems: "center",
  ...
  bellowsCardBadgeText: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#f97316" },
  bellowsCardBody: { flex: 1 },
  bellowsCardLabel: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#e2e8f0", marginBottom: 2 },
  bellowsCardText: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#8b91ad", lineHeight: 15 },
  // ── LaurelKnotDecoderBlock ──
  knotContainer: { gap: 6 },
  knotTitle: { fontFamily: "DroidSerifRegular", fontSize: 14, fontWeight: "700", color: "#4ade80", marginBottom: 2 },
  knotSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", marginBottom: 4 },
  knotPurposeHint: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#6b7280", fontStyle: "italic", marginBottom: 8, lineHeight: 15 },
  knotCord: {
  ...
  knotCordLabel: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#86efac", flex: 1 },
  knotCordMark: { fontFamily: "DroidSerifRegular", fontSize: 10, color: "#8b91ad", fontStyle: "italic" },
  knotOptions: { gap: 4 },
  knotOption: {
    padding: 7,
    borderRadius: 6,
  ...
  knotOptionText: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#9ca3af", lineHeight: 15 },
  knotOptionTextSelected: { color: "#86efac", fontWeight: "600" },
  // ── SunstoneReflectionArrayBlock ──
  sunstoneContainer: { gap: 6 },
  sunstoneTitle: { fontFamily: "DroidSerifRegular", fontSize: 14, fontWeight: "700", color: "#fbbf24", marginBottom: 2 },
  sunstoneSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", marginBottom: 4 },
  sunstonePurposeHint: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#6b7280", fontStyle: "italic", marginBottom: 8, lineHeight: 15 },
  sunstoneMirror: {
  ...
  sunstoneMirrorLabel: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#fde68a", flex: 1 },
  sunstoneMirrorBeam: { fontFamily: "DroidSerifRegular", fontSize: 10, color: "#8b91ad", fontStyle: "italic" },
  ...
  sunstoneOptionText: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#9ca3af", lineHeight: 15 },
  sunstoneOptionTextSelected: { color: "#fde68a", fontWeight: "600" },
  // ── RavenFeatherLatticeBlock ──
  ravenContainer: { gap: 6 },
  ravenTitle: { fontFamily: "DroidSerifRegular", fontSize: 14, fontWeight: "700", color: "#818cf8", marginBottom: 2 },
  ravenSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", marginBottom: 4 },
  ravenPurposeHint: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#6b7280", fontStyle: "italic", marginBottom: 8, lineHeight: 15 },
  ravenFeather: {
  ...
  ravenFeatherLabel: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#c7d2fe", flex: 1 },
  ravenFeatherMark: { fontFamily: "DroidSerifRegular", fontSize: 10, color: "#8b91ad", fontStyle: "italic" },
  ravenOptions: { gap: 4 },
  ravenOption: {
    padding: 7,
    borderRadius: 6,
  ...
  ravenOptionText: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#9ca3af", lineHeight: 15 },
  ...
  ledgerTitleText: { fontFamily: "DroidSerifRegular", fontSize: 11, fontWeight: "700", color: "#00FF41", letterSpacing: 0.8, flex: 1 },
  ledgerSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", lineHeight: 17 },
  ledgerPurpose: {
    padding: 9, borderLeftWidth: 2, borderLeftColor: "#00FF41",
    backgroundColor: "rgba(0,255,65,0.05)", borderRadius: 4,
  },
  ledgerPurposeLabel: { fontFamily: "DroidSerifRegular", fontSize: 10, fontWeight: "700", color: "#00FF41", letterSpacing: 0.6, marginBottom: 3 },
  ledgerPurposeText: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#c8d0e0", lineHeight: 17 },
  ledgerRule: {
    padding: 8, borderRadius: 6,
    backgroundColor: "rgba(255,255,255,0.03)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)",
  },
  ledgerRuleLabel: { fontFamily: "DroidSerifRegular", fontSize: 10, fontWeight: "700", color: "#6b7280", letterSpacing: 0.5, marginBottom: 3 },
  ledgerRuleText: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#a0a8bc", lineHeight: 16 },
  ledgerEntry: {
  ...
  ledgerEntryLabel: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#e8eaf2" },
  ...
  ledgerEntryTime: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#8b91ad" },
  ledgerEntryTimeVal: { color: "#fbbf24", fontFamily: Platform.OS === "ios" ? "Courier" : "monospace" },
  ledgerAuditNote: { fontFamily: "DroidSerifRegular", fontSize: 10, color: "#6b7280", fontStyle: "italic", lineHeight: 14 },
  ledgerCodeLabel: { fontFamily: "DroidSerifRegular", fontSize: 10, fontWeight: "700", color: "#6b7280", letterSpacing: 0.5, marginTop: 4 },
  ...
  ledgerWrongMsg: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#fca5a5", textAlign: "center" },
  ledgerHintBtn: {
  ...
  ledgerHintText: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#e0b54e" },
  ledgerHintReveal: {
    padding: 9, borderRadius: 8, borderWidth: 1, borderColor: "#b45309",
    backgroundColor: "rgba(180,83,9,0.08)",
  },
  ledgerHintRevealText: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#fbbf24", lineHeight: 17 },
  ledgerSubmitBtn: {
    paddingVertical: 11, borderRadius: 8, alignItems: "center",
    backgroundColor: "#00FF41",
  },
  ledgerSubmitBtnDisabled: { opacity: 0.45 },
  ledgerSubmitText: { fontFamily: "DroidSerifRegular", fontSize: 13, fontWeight: "700", color: "#0a1a0a" },
  // ── BlockchainTransactionForkBlock ──
  btfBlock: { gap: 8 },
  ...
  btfTitle: { fontFamily: "DroidSerifRegular", fontSize: 11, fontWeight: "700", color: "#00FF41", letterSpacing: 0.8, flex: 1 },
  btfSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", lineHeight: 17 },
  btfPurpose: { padding: 9, borderLeftWidth: 2, borderLeftColor: "#00FF41", backgroundColor: "rgba(0,255,65,0.04)", borderRadius: 4 },
  btfPurposeText: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#c8d0e0", lineHeight: 17 },
  btfInstruction: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#6b7280", fontStyle: "italic", marginTop: 2 },
  ...
  btfBranchLabel: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#9ca3af" },
  btfBranchLabelSel: { color: "#00FF41" },
  btfBranchMeta: { flexDirection: "row", flexWrap: "wrap", gap: 2, alignItems: "center" },
  btfMetaKey: { fontFamily: "DroidSerifRegular", fontSize: 10, color: "#6b7280", fontWeight: "600" },
  btfMetaVal: { fontSize: 10, color: "#fbbf24", marginLeft: 3, fontFamily: Platform.OS === "ios" ? "Courier" : "monospace" },
  btfBranchNote: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#8b91ad", fontStyle: "italic", lineHeight: 15 },
  btfWrong: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#fca5a5", textAlign: "center" },
  // ── DeepfakeFrameArtifactAnalysisBlock ──
  dfBlock: { gap: 8 },
  ...
  dfTitle: { fontFamily: "DroidSerifRegular", fontSize: 11, fontWeight: "700", color: "#f472b6", letterSpacing: 0.8, flex: 1 },
  dfSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", lineHeight: 17 },
  dfPurpose: { padding: 9, borderLeftWidth: 2, borderLeftColor: "#f472b6", backgroundColor: "rgba(244,114,182,0.05)", borderRadius: 4 },
  dfPurposeText: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#c8d0e0", lineHeight: 17 },
  dfInstruction: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#f9a8d4", fontWeight: "600", marginTop: 2 },
  ...
  dfFrameLabel: { fontFamily: "DroidSerifRegular", fontSize: 10, fontWeight: "700", color: "#9ca3af" },
  dfFrameVisual: { fontFamily: "DroidSerifRegular", fontSize: 10, color: "#6b7280", fontStyle: "italic", lineHeight: 14 },
  dfFrameArtifact: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#86efac", fontWeight: "600" },
  dfFrameEmpty: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#4a5070", fontStyle: "italic" },
  dfArtifacts: { gap: 5, marginTop: 4 },
  dfArtifactsLabel: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#f9a8d4", fontWeight: "600" },
  ...
  dfArtifactLabel: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#e8eaf2" },
  dfArtifactChosenText: { color: "#f472b6" },
  dfArtifactNote: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#8b91ad", lineHeight: 15 },
  dfWrong: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#fca5a5", textAlign: "center" },
  // ── TorNodeRouteBlock ──
  torBlock: { gap: 8 },
  ...
  torTitle: { fontFamily: "DroidSerifRegular", fontSize: 11, fontWeight: "700", color: "#22d3ee", letterSpacing: 0.8, flex: 1 },
  torSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", lineHeight: 17 },
  torPurpose: { padding: 9, borderLeftWidth: 2, borderLeftColor: "#22d3ee", backgroundColor: "rgba(34,211,238,0.04)", borderRadius: 4 },
  torPurposeText: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#c8d0e0", lineHeight: 17 },
  torTarget: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#8b91ad" },
  torTargetVal: { color: "#22d3ee", fontWeight: "700", fontFamily: Platform.OS === "ios" ? "Courier" : "monospace" },
  torInstruction: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#67e8f9", fontStyle: "italic", marginTop: 2 },
  ...
  torNodeLabel: { fontFamily: "DroidSerifRegular", fontSize: 10, color: "#9ca3af", textAlign: "center", lineHeight: 14 },
  ...
  torClearText: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#dc2626", fontWeight: "600" },
  torWrong: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#fca5a5", textAlign: "center" },
  // ── BadgeUpsCorrelationBlock ──
  upsBlock: { gap: 8 },
  ...
  upsTitle: { fontFamily: "DroidSerifRegular", fontSize: 11, fontWeight: "700", color: "#60a5fa", letterSpacing: 0.8, flex: 1 },
  upsSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", lineHeight: 17 },
  upsPurpose: { padding: 9, borderLeftWidth: 2, borderLeftColor: "#60a5fa", backgroundColor: "rgba(96,165,250,0.04)", borderRadius: 4 },
  upsPurposeText: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#c8d0e0", lineHeight: 17 },
  upsInstruction: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#6b7280", fontStyle: "italic", marginTop: 2 },
  ...
  upsWindowLabel: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#9ca3af" },
  ...
  upsDataKey: { fontFamily: "DroidSerifRegular", fontSize: 9, color: "#6b7280", fontWeight: "600", letterSpacing: 0.3 },
  ...
  upsWindowNote: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#8b91ad", fontStyle: "italic", lineHeight: 15 },
  upsWrong: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#fca5a5", textAlign: "center" },
  // ── IoTCommandChainBlock ──
  iotBlock: { gap: 8 },
  ...
  iotTitle: { fontFamily: "DroidSerifRegular", fontSize: 11, fontWeight: "700", color: "#a78bfa", letterSpacing: 0.8, flex: 1 },
  iotSubtitle: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#8b91ad", lineHeight: 17 },
  iotPurpose: { padding: 9, borderLeftWidth: 2, borderLeftColor: "#a78bfa", backgroundColor: "rgba(167,139,250,0.04)", borderRadius: 4 },
  iotPurposeText: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#c8d0e0", lineHeight: 17 },
  iotInstruction: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#c4b5fd", fontStyle: "italic", marginTop: 2 },
  ...
  iotNodeLabel: { fontFamily: "DroidSerifRegular", fontSize: 12, fontWeight: "700", color: "#9ca3af", flex: 1 },
  iotNodeLabelSource: { color: "#a78bfa" },
  iotNodePort: { fontFamily: "DroidSerifRegular", fontSize: 10, color: "#6b7280", lineHeight: 14 },
  iotEdgeTag: { fontFamily: "DroidSerifRegular", fontSize: 11, color: "#86efac", fontWeight: "600", marginTop: 2 },
  iotClearBtn: { paddingVertical: 6, alignItems: "center" },
  iotClearText: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#dc2626", fontWeight: "600" },
  iotWrong: { fontFamily: "DroidSerifRegular", fontSize: 12, color: "#fca5a5", textAlign: "center" },
});
