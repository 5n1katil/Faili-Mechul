...
export const PUZZLES: Puzzle[] = [
  ...
  },
  {
    ...
    dayIndex: 30,
    story:
      "Karaköy'deki gece kulübünde bir müşteri servis çıkışında ölü bulundu. Üç çalışan şüpheli: Mete, Deniz ve Hakan.",
    suspects: [
      { id: "s1", name: "Mete", description: "DJ ve kulüp sahibi.", icon: "face" },
      { id: "s2", name: "Deniz", description: "Kasiyer.", icon: "person" },
      { id: "s3", name: "Hakan", description: "Güvenlik görevlisi.", icon: "local-police" },
    ],
    weapons: [
      { id: "w1", name: "Bardak", description: "Cam, kırılabilir yüzeyli.", icon: "local-bar" },
      { id: "w2", name: "Kablo", description: "İnce, esnek elektrik kablosu.", icon: "electrical-services" },
      { id: "w3", name: "Metal Fener", description: "Ağır ve sert yüzeyli el feneri.", icon: "flashlight-on" },
    ],
    locations: [
      { id: "l1", name: "Bar Alanı", description: "Kulübün ana bar ve dans alanı.", icon: "nightlife" },
      { id: "l2", name: "VIP Lounge", description: "Yarı özel, ayrıcalıklı oturma bölümü.", icon: "star" },
      { id: "l3", name: "Servis Çıkışı", description: "Arka taraftaki karanlık servis koridoru.", icon: "door-back" },
    ],
    clues: [
      { id: "c1", text: "Adli inceleme, ölümün kafa travması sonucu olduğunu gösteriyor.", type: "forensic", isBonus: false },
      { id: "c2", text: "Kurban servis çıkışında bulundu; vücudunda sürüklenme izi yok.", type: "evidence", isBonus: false },
      { id: "c3", text: "DJ Mete olay sırasında sahne arkasındaydı ve bar alanından ayrılmadı.", type: "witness", isBonus: false },
      { id: "c4", text: "Deniz'in olay saatinde VIP bölümde işlem yaptığı kasa kayıtlarıyla doğrulandı.", type: "witness", isBonus: false },
      { id: "c5", text: "Kafa travması tek ve sert bir darbeden kaynaklanmış; cam kırığına rastlanmadı.", type: "forensic", isBonus: false },
      { id: "c6", text: "Servis çıkışındaki metal fenerin üzerinde kurbana ait kan izi bulundu.", type: "evidence", isBonus: true },
    ],
    solvabilityMeta: {
