...
export const PUZZLES: Puzzle[] = [
  ...
  },
  {
    ...
    dayIndex: 33,
    story:
      "Akşam vapurunda Nafiz Bey kapalı yolcu salonunda ölü bulundu. Üç yolcu şüpheli: Tarık, Feriha ve Kerem.",
    suspects: [
      { id: "s1", name: "Tarık", description: "Genç öğrenci yolcu.", icon: "person" },
      { id: "s2", name: "Feriha", description: "Hemşire.", icon: "medical-services" },
      { id: "s3", name: "Kerem", description: "Avukat.", icon: "badge" },
    ],
    weapons: [
      { id: "w1", name: "Uyku İlacı", description: "İçeceğe karıştırılabilir çözünür tablet.", icon: "medication" },
      { id: "w2", name: "Zincir", description: "Güvertede bulunan kalın metal zincir.", icon: "link" },
      { id: "w3", name: "Bardak", description: "Cam, kırılabilir yüzeyli.", icon: "local-bar" },
    ],
    locations: [
    ...
    clues: [
      { id: "c1", text: "Nafiz Bey'in üzerinde darp izi yok. Ölüm, içeceğe karışan bir maddeden kaynaklanmış görünüyor.", type: "forensic", isBonus: false },
      { id: "c2", text: "İçeceğin bulunduğu bardak kapalı yolcu salonundaki masadaydı.", type: "evidence", isBonus: false },
      { id: "c3", text: "Tarık yolculuk boyunca açık güvertede oturduğunu ve salona hiç inmediğini söylüyor; kaptan bunu doğruluyor.", type: "witness", isBonus: false },
      { id: "c4", text: "Kerem'in olay saatinde makine bölümünde görevli olduğu kayıtlarla doğrulandı.", type: "witness", isBonus: false },
      { id: "c5", text: "İçeceğe karışan madde tamamen çözünmüş; cam bardak üzerinde darbe izi yok.", type: "forensic", isBonus: false },
      { id: "c6", text: "Feriha'nın çantasında eksilmiş bir uyku ilacı şişesi bulundu.", type: "evidence", isBonus: true },
    ],
    solvabilityMeta: {
      freeEliminations: ["l2", "l3", "s1", "s3", "w2", "w3"],
      bonusEliminations: [],
