...
export const PUZZLES: Puzzle[] = [
  ...
  },
  {
    ...
    dayIndex: 33,
    story:
      "Akşam vapurunda elektrik kesintisi sırasında Nafiz Bey kapalı salonunda ölü bulundu. Üç şüpheli, üç silah, üç farklı alan var.",
    suspects: [
      { id: "s1", name: "Tarık", description: "Yolculuk boyunca açık güvertede olduğunu söylüyor.", icon: "person" },
      { id: "s2", name: "Feriha", description: "Kapalı salonda kısa süre bulunduğunu kabul ediyor. Nafiz Bey'i tanımadığını söylüyor.", icon: "medical-services" },
      { id: "s3", name: "Kerem", description: "Vapurda görevli personel. Olay saatinde makine bölümünde olduğunu söylüyor.", icon: "badge" },
    ],
    weapons: [
      { id: "w1", name: "Zehir", description: "İçeceğe karışan hızlı etkili çözünür madde.", icon: "science" },
      { id: "w2", name: "İngiliz Anahtarı", description: "Makine bölümünde bulunan ağır metal alet.", icon: "build" },
      { id: "w3", name: "Cam Parçası", description: "Keskin kenarlı kırık cam.", icon: "local-bar" },
    ],
    locations: [
      { id: "l1", name: "Kapalı Salon", description: "Güverte altındaki kapalı yolcu bekleme salonu.", icon: "weekend" },
    ...
    clues: [
      { id: "c1", text: "Ölüm zehirle gerçekleşti. Fiziksel darbe izine rastlanmadı.", type: "forensic", isBonus: false },
      { id: "c2", text: "Tarık olay sırasında açık güvertedeydi. Kaptan bunu doğruluyor.", type: "witness", isBonus: false },
      { id: "c3", text: "Kerem makine bölümünde görevliydi. Kayıtlar bunu doğruluyor.", type: "witness", isBonus: false },
      { id: "c4", text: "Zehir kullanılan olay makine bölümünde gerçekleşmedi.", type: "forensic", isBonus: true },
      { id: "c5", text: "Açık güvertede zehir kullanılmadı.", type: "forensic", isBonus: true },
      { id: "c6", text: "Cam parçası kullanılan olay kapalı salonda olmadı.", type: "evidence", isBonus: true },
    ],
    solvabilityMeta: {
      freeEliminations: ["w2", "w3", "s1", "s3", "l2", "l3"],
      bonusEliminations: [],
    },
    solution: { suspectId: "s2", weaponId: "w1", locationId: "l1" },
  },
