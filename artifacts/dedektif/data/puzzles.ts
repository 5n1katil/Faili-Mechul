...
export const PUZZLES: Puzzle[] = [
  {
    ...
    suspects: [
      ...
      { id: "s3", name: "Zeynep Hanım", description: "Davetli.", icon: "woman" },
    ],
    weapons: [
    ...
    locations: [
      ...
      { id: "l2", name: "Bahçe", description: "Açık hava.", icon: "yard" },
      { id: "l3", name: "Mutfak", description: "Cinayet mahalli.", icon: "soup_kitchen" },
    ],
    clues: [
      {
        id: "c1",
