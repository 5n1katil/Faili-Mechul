...
export const PUZZLES: Puzzle[] = [
  {
    ...
    suspects: [
      { id: "s1", name: "Nazik Hanım", description: "Ev sahibinin eski dostu ve sosyete figürü. Bahçe düzenlemesini bizzat yönetti.", icon: "theater_comedy" },
      { id: "s2", name: "Cem", description: "Konağa yeni katılan genç uşak. Kütüphane ve servis düzeninden sorumluydu.", icon: "work" },
      { id: "s3", name: "Zeynep", description: "Davetin aşçısı. Mutfak ve yemek servisinin tek sorumlusu.", icon: "restaurant" },
    ],
    weapons: [
      ...
      { id: "w3", name: "Dekorasyon İpi", description: "Konakta teras süslemesi için kullanılan kalın bağ ipi.", icon: "commit" },
    ],
    locations: [
      ...
      { id: "l3", name: "Mutfak", description: "Konağın servis mutfağı; bıçak setleri ve servis tepsilerine ev sahipliği yapar.", icon: "restaurant" },
    ],
    clues: [
      {
        id: "c1",
      ...
      {
        id: "c2",
        text: "Selma mutfak kapısının yanında bulundu. Zemindeki kan birikimi, devrilmiş servis tepsisi ve kırılmış tabaklar olayın bu mekânda gerçekleştiğine işaret ediyor; kütüphane ve bahçede mücadele ya da kan izi tespit edilmedi.",
        type: "evidence",
        isBonus: false,
      },
      {
