...
export const PUZZLES: Puzzle[] = [
  {
    ...
    dayIndex: 1,
    story:
      "Tarihi konaktaki gece davetinin ardından ev sahibinin yardımcısı Selma sabah mutfakta ölü bulundu. Konağın içinde kalan üç kişi sorguya alındı.",
    suspects: [
      { id: "s1", name: "Nazik Hanım", description: "Emekli tiyatro sanatçısı. Gece boyunca bahçedeki konuklarla ilgilendiğini söylüyor.", icon: "theater_comedy" },
      { id: "s2", name: "Zeynep Hanım", description: "Ev sahibinin yakın dostu. Davet sırasında mutfak düzenine yardım ettiğini kabul ediyor.", icon: "business_center" },
      { id: "s3", name: "Cem", description: "Konağın servis görevlisi. Gece sonunda kütüphanedeki bardakları topladığını söylüyor.", icon: "room_service" },
    ],
    weapons: [
      { id: "w1", name: "Mutfak Bıçağı", description: "Kesici-delici büyük servis bıçağı.", icon: "content_cut" },
      { id: "w2", name: "Ağır Şamdan", description: "Bahçe masalarında kullanılan metal şamdan.", icon: "emoji_objects" },
      { id: "w3", name: "Antika Tabanca", description: "Kütüphanedeki vitrinde sergilenen eski tabanca.", icon: "gps_fixed" },
    ],
    locations: [
      { id: "l1", name: "Kütüphane", description: "Kitaplıklarla çevrili sessiz oda.", icon: "menu_book" },
      { id: "l2", name: "Mutfak", description: "Servis hazırlığının yapıldığı arka bölüm.", icon: "restaurant" },
      { id: "l3", name: "Bahçe", description: "Havuz kenarı ve açık davet alanı.", icon: "park" },
    ],
    clues: [
      {
        id: "c1",
        text: "Otopside Selma’nın tek ve derin bir kesici-delici yara nedeniyle öldüğü belirlendi. Barut izi, mermi çekirdeği ya da ağır ezilme travması bulunmadı.",
        type: "forensic",
        isBonus: false,
      },
      {
        id: "c2",
        text: "Selma mutfak kapısının yanında bulundu. Zemindeki kan birikimi, devrilmiş servis tepsisi ve kırılmış tabaklar olayın mutfakta gerçekleştiğini gösteriyor.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c3",
        text: "Nazik Hanım gece boyunca bahçede konuklarla birlikteydi. Havuz kenarındaki masa düzeniyle ilgilendiği görüldü; mutfağa ya da kütüphaneye girdiğine dair tanık yok.",
        type: "witness",
        isBonus: false,
      },
      {
      ...
      {
        id: "c7",
        text: "Kütüphanedeki antika tabanca vitrindeydi ve dolu değildi. Cam vitrinde kırılma, zorlama ya da yakın zamanda açılma izi görülmedi.",
        type: "evidence",
        isBonus: true,
      },
      {
  ...
  },
  {
    ...
    dayIndex: 2,
    story:
      "İstanbul Boğazı’nda düzenlenen lüks yat partisinde sergilenen Boğaz Elması gece yarısından sonra kayboldu. Aynı saatlerde güvenlik görevlisi Orhan, makine dairesinde ölü bulundu.",
    suspects: [
      { id: "s1", name: "Dilek Hanım", description: "Elmasın sergilendiği kasanın sorumlusuydu. Güvenlik kodlarını bildiğini kabul ediyor.", icon: "diversity_3" },
      { id: "s2", name: "Levent Kaptan", description: "Yatın kaptanı. Olay sırasında köprüde olduğunu söylüyor.", icon: "account_circle" },
      { id: "s3", name: "Murat Aydın", description: "Davetli iş insanı. Gece boyunca VIP salonda konuklarla görüştüğünü söylüyor.", icon: "business_center" },
    ],
    weapons: [
      { id: "w1", name: "Çelik Halat", description: "Makine bölümünde kullanılan ince ama güçlü bağlantı halatı.", icon: "cable" },
      { id: "w2", name: "Demir Çubuk", description: "Güvertede bakım için kullanılan ağır metal çubuk.", icon: "horizontal_rule" },
      { id: "w3", name: "Gaz Maskesi", description: "Acil durum dolabında bulunan koruyucu ekipman.", icon: "air" },
    ],
    locations: [
      { id: "l1", name: "Makine Dairesi", description: "Yatın alt bölümündeki teknik alan.", icon: "waves" },
      { id: "l2", name: "Köprü", description: "Kaptanın seyir ve rota kontrolünü yaptığı bölüm.", icon: "settings_input_antenna" },
      { id: "l3", name: "VIP Salon", description: "Elmasın sergilendiği özel davet alanı.", icon: "star" },
    ],
    clues: [
      {
        id: "c1",
        text: "Adli rapor, Orhan’ın boyun çevresindeki ince ve düzenli baskı izleri nedeniyle boğularak öldüğünü gösteriyor. Kafatasında ağır darbe izi, yüzünde ise gaz solumaya bağlı tahriş bulgusu yok.",
        type: "forensic",
        isBonus: false,
      },
      {
        id: "c2",
        text: "Orhan makine dairesindeki kilitli bakım koridorunda bulundu. Zemindeki sürtünme izi, kopmuş halat lifi ve yağlı ayakkabı izleri olayın burada gerçekleştiğini gösteriyor.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c3",
        text: "Levent Kaptan’ın olay saatinde köprüde olduğu seyir kayıtlarıyla doğrulandı. Rota değişikliği ve telsiz konuşmaları aynı dakikalarda onun köprüden ayrılmadığını gösteriyor.",
        type: "record",
        isBonus: false,
      },
      {
        id: "c4",
        text: "Murat Aydın’ın olay sırasında VIP salonda üç farklı konukla görüştüğü, servis kayıtları ve salon görevlilerinin ifadeleriyle doğrulandı. Makine dairesine indiğine dair kayıt yok.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c5",
        text: "Makine dairesinin giriş panelinde Dilek Hanım’a ait geçici erişim kodu kullanılmış. Aynı kod, elmas kasasının açıldığı dakikadan kısa süre sonra teknik kata iniş için de girilmiş.",
        type: "record",
        isBonus: false,
      },
      {
        id: "c6",
        text: "Güvertedeki demir çubukta yalnızca pas ve eski yağ lekesi bulundu. Üzerinde kan, deri dokusu ya da yeni temas izi yoktu.",
        type: "forensic",
        isBonus: true,
      },
      {
        id: "c7",
        text: "Acil durum dolabındaki gaz maskesinin mührü kırılmamıştı. Maskenin gece boyunca yerinden çıkarılmadığı güvenlik kontrol listesinde de görünüyor.",
        type: "evidence",
        isBonus: true,
      },
      {
        id: "c8",
        text: "Elmas kasasının yanındaki not defterinde Dilek Hanım’ın makine dairesi bakım koridoruna ait kodu daha önce not aldığı görüldü.",
        type: "evidence",
        isBonus: true,
      },
    ],
