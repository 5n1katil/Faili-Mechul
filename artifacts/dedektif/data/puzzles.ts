...
export const PUZZLES: Puzzle[] = [
  ...
  },
  {
    ...
    dayIndex: 30,
    story:
      "Karaköy'de bir gece kulübünde müşteri servis çıkışında ölü bulundu. Üç çalışan şüpheli: Mete, Deniz ve Hakan.",
    suspects: [
      { id: "s1", name: "Mete", description: "DJ. Olay sırasında sahne arkasında olduğunu ve setini hiç bırakmadığını söylüyor.", icon: "face" },
      { id: "s2", name: "Deniz", description: "Kasada çalışıyor. Olay saatinde VIP bölümde işlem yaptığını söylüyor.", icon: "person" },
      { id: "s3", name: "Hakan", description: "Güvenlik görevlisi. Kulüp içinde devriye attığını söylüyor.", icon: "local-police" },
    ],
    weapons: [
      { id: "w1", name: "Sert Cisim Darbesi", description: "Kafa bölgesine uygulanan tek ve güçlü bir darbe.", icon: "gavel" },
      { id: "w2", name: "Kırık Şişe", description: "Keskin kenarlı kırık cam şişe.", icon: "local-bar" },
      { id: "w3", name: "Yumruk", description: "El ile uygulanan doğrudan fiziksel kuvvet.", icon: "sports-mma" },
    ],
    locations: [
      { id: "l1", name: "Servis Çıkışı", description: "Arka taraftaki kamera kör noktasındaki servis çıkışı.", icon: "door-back" },
      { id: "l2", name: "Sahne Arkası", description: "DJ kabini ve ses ekipmanlarının bulunduğu alan.", icon: "queue-music" },
      { id: "l3", name: "VIP Bölüm", description: "Kulübün yarı özel ayrıcalıklı oturma bölümü.", icon: "star" },
    ],
    clues: [
      { id: "c1", text: "Adli inceleme, ölümün kafa bölgesine alınan tek ve güçlü bir darbe sonucu gerçekleştiğini gösteriyor. Birden fazla darbe ya da uzun süren bir mücadele izine rastlanmadı.", type: "forensic", isBonus: false },
      { id: "c2", text: "Kurban servis çıkışında bulundu. Vücudunda sürüklenme ya da taşınma izi yok. Bu, darbenin bulunduğu noktada gerçekleştiğini gösteriyor.", type: "evidence", isBonus: false },
      { id: "c3", text: "Kulüp çalışanları, DJ Mete'nin olay boyunca sahne arkasında olduğunu ve müziğin kesilmediğini belirtiyor. DJ kabini kısa süreliğine bile boş kalmamış.", type: "witness", isBonus: false },
      { id: "c4", text: "Deniz'in olay saatinde VIP bölümde işlem yaptığı kasa kayıtlarıyla doğrulandı. İşlem süresi boyunca sistemden çıkış yapmadığı görülüyor.", type: "witness", isBonus: false },
      { id: "c5", text: "Olay yerinde kırık cam, şişe ya da kesici bir nesneye rastlanmadı. Darbenin temiz ve doğrudan bir temasla gerçekleştiği anlaşılıyor.", type: "forensic", isBonus: false },
      { id: "c6", text: "Servis çıkışı, güvenlik kameralarının doğrudan görmediği bir kör noktada bulunuyor. Güvenlik görevlisi Hakan'ın devriye güzergahı bu noktadan geçiyor.", type: "witness", isBonus: true },
    ],
    solvabilityMeta: {
      freeEliminations: ["w3", "s1", "l2", "s2", "l3", "w2"],
      bonusEliminations: [],
    },
    solution: { suspectId: "s3", weaponId: "w1", locationId: "l1" },
  },
  ...
  },
  {
    ...
    dayIndex: 33,
    story:
      "Akşam vapurunda Nafiz Bey kapalı yolcu salonunda ölü bulundu. Masasında yarım kalmış bir içecek vardı. Üç yolcu şüpheli: Tarık, Feriha ve Kerem.",
    suspects: [
      { id: "s1", name: "Tarık", description: "Yolculuk boyunca üst güvertede olduğunu söylüyor. Kaptan onu uzun süre açık güvertede gördüğünü doğruluyor.", icon: "person" },
      { id: "s2", name: "Feriha", description: "Kapalı yolcu salonunda kısa süre bulunduğunu kabul ediyor. Nafiz Bey'i tanımadığını söylüyor.", icon: "medical-services" },
      { id: "s3", name: "Kerem", description: "Vapurda görevli personel. Olay saatinde makine bölümünde olduğunu söylüyor ve kayıtlar bunu destekliyor.", icon: "badge" },
    ],
    weapons: [
      { id: "w1", name: "Zehirli İçecek", description: "İçeceğe karışan, hızlı etkili çözünür madde.", icon: "medication" },
      { id: "w2", name: "Demir Çubuk", description: "Uzun, ince ve köşeli metal çubuk.", icon: "build" },
      { id: "w3", name: "Cam Parçası", description: "Keskin kenarlı kırık cam.", icon: "broken-image" },
    ],
    locations: [
      { id: "l1", name: "Kapalı Yolcu Salonu", description: "Güverte altındaki kapalı yolcu bekleme salonu.", icon: "weekend" },
      { id: "l2", name: "Açık Güverte", description: "Vapurun üst katındaki açık hava güverte alanı.", icon: "directions-boat" },
      { id: "l3", name: "Makine Bölümü", description: "Alt kattaki makine ve pompa odası; yolculara kapalı.", icon: "engineering" },
    ],
    clues: [
      { id: "c1", text: "Nafiz Bey'in üzerinde darp izi yok. Ölümün içeceğe karışan hızlı etkili bir maddeden kaynaklandığı düşünülüyor.", type: "forensic", isBonus: false },
      { id: "c2", text: "İçeceğin bulunduğu bardak kapalı yolcu salonundaki masadaydı. Bardakta dışarıdan taşınma ya da kırılma izi yoktu.", type: "evidence", isBonus: false },
      { id: "c3", text: "Kaptan, Tarık'ı yolculuk boyunca açık güvertede gördüğünü söylüyor. Tarık'ın kapalı yolcu salonuna indiğine dair bir tanık ifadesi yok.", type: "witness", isBonus: false },
      { id: "c4", text: "Kerem'in olay saatinde makine bölümünde görevli olduğu kayıtlarla doğrulandı. Kayıtlarda makine bölümünden ayrıldığına dair bir işaret yok.", type: "witness", isBonus: false },
      { id: "c5", text: "İçeceğe karışan madde tamamen çözünmüş. Bardak üzerinde parmak izi silinmiş; ancak bardağın yerinden oynatıldığına dair iz yok.", type: "forensic", isBonus: true },
      { id: "c6", text: "Bir yolcu, elektrik kesintisinden hemen önce Feriha'nın kapalı yolcu salonunda Nafiz Bey'in masasının yanında kısa süre durduğunu söylüyor.", type: "witness", isBonus: true },
    ],
    solvabilityMeta: {
      freeEliminations: ["l2", "l3", "s1", "s3", "w2", "w3"],
      bonusEliminations: [],
