...
export const PUZZLES: Puzzle[] = [
  ...
  },
  {
    ...
    clues: [
      ...
      {
        id: "c2",
        text: "Olay Yeri İncelemesi: Ceset, geminin zemini tamamen makine yağıyla kaplı en alt katında bulundu. Aydınlık eğlence salonunda ya da yönetim merkezinde hiçbir boğuşma izi yok.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c3",
        text: "Telsiz ve görev kayıtlarına göre; Kaptan Levent olay saatinde yönetim merkezinden hiç ayrılmamış ve oradaki kırık bir paneli ağır bir tamir aletiyle onarmaktaydı.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c4",
        text: "Tanık İfadeleri: Sponsor Murat, cinayet işlendiği sırada lüks eğlence alanındaydı ve konuklarına basınçlı tüpler kullanılarak yapılan özel bir duman şovunu sunuyordu.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c5",
        text: "Ek İnceleme: Organizatör Eda'nın ayakkabılarında ve elbisesinin eteklerinde, yalnızca geminin en alt katındaki motor bölümünde bulunabilen yoğun sentetik sintine yağı lekeleri tespit edildi.",
        type: "evidence",
        isBonus: true,
      },
      {
        id: "c6",
        text: "Kesin Kanıt: Cinayette kullanılan sentetik ipten alınan doku örnekleri ve özel düğüm atma tekniği, Organizatör Eda ile birebir eşleşti.",
        type: "forensic",
        isBonus: true,
      },
    ],
