...
export const PUZZLES: Puzzle[] = [
  {
    ...
    dayIndex: 1,
    story:
      "Tarihi bir konakta gece yarısına kadar süren bir davetin ardından ev sahibinin yardımcısı sabah kütüphanede ölü bulundu. Ancak kan izleri ve eksik mutfak ekipmanları, olayın göründüğü yerde başlamamış olabileceğini düşündürüyor.",
    suspects: [
      { id: "s1", name: "Nazik Hanım", description: "Davete katılan emekli tiyatro sanatçısı.", icon: "hiking" },
      { id: "s2", name: "Zeynep Hanım", description: "Ev sahibinin yakın dostu ve sık davet konuğu.", icon: "business_center" },
      { id: "s3", name: "Cem", description: "Konağın genç aşçı yardımcısı.", icon: "mood" },
    ],
    weapons: [
    ...
    locations: [
      ...
      { id: "l2", name: "Mutfak", description: "Hazırlık ve servis alanı.", icon: "restaurant" },
      { id: "l3", name: "Bahçe", description: "Havuz ve yürüyüş alanı.", icon: "park" },
    ],
    clues: [
      {
        id: "c1",
        text: "Otopside tek ve derin bir kesici-delici yara tespit edildi. Mermi çekirdeği, barut izi ya da ağır ezilme travması bulunmadı.",
        type: "forensic",
        isBonus: false,
      },
      {
        id: "c2",
        text: "Nazik Hanım’ın gece boyunca bahçede, havuz kenarında konuklarla vakit geçirdiği birden fazla tanık tarafından doğrulandı. Konağın içine uzun süre girdiği görülmedi.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c3",
        text: "Zeynep Hanım’ın davet boyunca kütüphanede bulunduğu söylense de hizmetliler, gece yarısından kısa süre önce onu mutfaktan telaşla çıkarken gördüklerini ifade etti.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c4",
        text: "Mutfak tezgahı altında ince kan damlaları bulundu. Bıçak setindeki büyük şef bıçağının ise temizlenmiş olmasına rağmen yerine aceleyle bırakıldığı fark edildi.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c5",
        text: "Kütüphanede cesedin bulunduğu bölgede geniş mücadele izi yoktu. Kan birikimi sınırlıydı; bu durum ölümcül yaralanmanın başka bir yerde gerçekleşmiş olabileceğini düşündürüyor.",
        type: "forensic",
        isBonus: false,
      },
      {
        id: "c6",
        text: "Bahçedeki güvenlik lambaları gece boyunca aktifti ve kayıtlarda Nazik Hanım’ın uzun süre havuz çevresinde dolaştığı görülüyor.",
        type: "record",
        isBonus: true,
      },
      {
        id: "c7",
        text: "Cem’in önlüğünde yalnızca yemek hazırlığına ait sebze ve sos lekeleri bulundu; kan ya da barut kalıntısına rastlanmadı.",
        type: "forensic",
        isBonus: true,
      },
      {
        id: "c8",
        text: "Hizmetliler, davetten hemen sonra mutfakta kısa süreli su sesi duyduklarını ancak içeride kimseyi görmediklerini söyledi.",
        type: "witness",
        isBonus: true,
      },
    ],
