...
export const PUZZLES: Puzzle[] = [
  {
    ...
    dayIndex: 1,
    story:
      "Tarihi bir konakta gece yarısına kadar süren bir davet vardı. Sabah erkenden ev sahibinin yardımcısı cesedi kütüphanede buldu. Ancak odadaki izlerin bir kısmı, ölümün tam olarak cesedin bulunduğu yerde gerçekleşmemiş olabileceğini düşündürüyor.",
    suspects: [
      { id: "s1", name: "Nazik Hanım", description: "Ev sahibinin dizinden rahatsız eski dostu; merdivenleri zor inip çıkıyor.", icon: "elderly" },
      { id: "s2", name: "Rıfat Bey", description: "Avukat ve iş ortağı; mutfak servis kapısını ve konak planını iyi biliyor.", icon: "badge" },
      { id: "s3", name: "Zeynep Hanım", description: "Genç yeğen; davet boyunca konuklarla kütüphanede satranç oynadığını söylüyor.", icon: "face" },
    ],
    weapons: [
      { id: "w1", name: "Bıçak", description: "Konak mutfağındaki setten eksik, ince ve uzun bir şef bıçağı.", icon: "content-cut" },
      { id: "w2", name: "Zehir", description: "Yiyeceğe karıştırıldığında dakikalar içinde etki eden bitkisel toksin karışımı.", icon: "local-pharmacy" },
      { id: "w3", name: "Tabanca", description: "Eski model revolver; ateşlendiğinde dar koridorlarda yankılanacak kadar gürültülü.", icon: "gps-fixed" },
    ],
    locations: [
      { id: "l1", name: "Kütüphane", description: "Deri ciltli kitaplarla dolu, meşe raflı tarihi oda", icon: "menu-book" },
      { id: "l2", name: "Mutfak", description: "Yemek hazırlığından sonra temizlenmiş görünen, servis kapısı aralıklı geniş mutfak.", icon: "restaurant" },
      { id: "l3", name: "Bahçe", description: "Fıskiyeli havuz ve asırlık çınarların bulunduğu loş bahçe", icon: "park" },
    ],
    clues: [
      {
        id: "c1",
        text: "Otopside tek ve derin bir kesici-delici yara tespit edildi. Mermi çekirdeği, barut izi ve toksik madde bulgusu yok.",
        type: "forensic",
        isBonus: false,
      },
      {
        id: "c2",
        text: "Nazik Hanım'ın tüm geceyi bahçede, havuz başında konuklarla geçirdiği birden fazla tanık tarafından doğrulandı.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c3",
        text: "Zeynep Hanım'ın davet boyunca kütüphanede kaldığı; gece boyunca aralıklarla aynı masada görüldüğü tanık ifadelerinde tutarlı.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c4",
        text: "Mutfak tezgahı altında ince kan damlaları ve bıçak setine ait boş kın bulundu. Kütüphanede ise geniş sıçrama yerine sadece sınırlı kan birikimi görüldü.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c5",
        text: "Servis koridorundaki kamera, Rıfat Bey'in gece yarısına yakın mutfak kapısı yönüne iki kez gidip geldiğini gösteriyor.",
        type: "record",
        isBonus: true,
      },
      {
        id: "c6",
        text: "Kütüphane kapısı iç kolunda Rıfat Bey'e ait taze parmak izi, mutfak eşiğinde ise aynı ayakkabı taban desenine ait iz bulundu.",
        type: "evidence",
        isBonus: true,
      },
    ],
