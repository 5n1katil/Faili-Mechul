...
export const PUZZLES: Puzzle[] = [
  ...
  },
  {
    ...
    clues: [
      { id: "c1", text: "Kurbanın yüzündeki şiddetli kasılma ve midesindeki kramp bulguları, sessiz ve renksiz bir katilin doğrudan sindirim sistemine sızdığını gösteriyordu.", type: "forensic", isBonus: false },
      { id: "c2", text: "Maktulün ceketindeki özel deri döşeme tozları ve masaya dökülen mürekkep, son nefesini sadece kendi şahsi krallığında, o ağır koltuğunda verdiğini belgeliyordu.", type: "evidence", isBonus: false },
      { id: "c3", text: "Öfkeli müteahhitin ayakkabılarındaki çamur izleri, onun yalnızca güvenlik kameralarıyla izlenen ve dışarıya açılan bekleme koridorlarında volta attığını kanıtlıyordu.", type: "record", isBonus: false },
      { id: "c4", text: "Siyasi rakibin o kritik saatlerde gazetecilerle canlı yayında tartışması, binanın içindeki bu sessiz infaz alanından millerce uzakta olduğunu doğruluyordu.", type: "evidence", isBonus: false },
      { id: "c5", text: "Odaya her sabah izinsiz ve sorgusuz sualsiz kahve tepsisiyle girebilen tek silüet, yılların alışkanlığıyla masaya en çok yaklaşan kadındı.", type: "evidence", isBonus: true },
      { id: "c6", text: "Fincanın porselen kenarındaki mikro kalıntılar, sekreterin çekmecesinde kilitli tuttuğu o nadir temizlik kimyasalının formülüyle birebir eşleşiyordu.", type: "forensic", isBonus: true },
    ],
    solvabilityMeta: {
  ...
  },
  {
    ...
    weapons: [
      ...
      { id: "w2", name: "Elektrik Darbesi", description: "Sahne zeminindeki metal plakalara kasıtlı olarak yönlendirilen ve dokunulduğunda ölümcül şok yaratan ana akım.", icon: "flash-on" },
      { id: "w3", name: "Gizli Enjeksiyon", description: "Kalabalık arasında fark edilmeden deriye temas ettirilebilen ince uçlu zehirli cerrahi iğne.", icon: "vaccines" },
    ],
    locations: [
  ...
  },
  {
    ...
    clues: [
      ...
      {
        id: "c1",
        text: "Kan sıçrama analizlerinin o loş ve özel korumalı asırlık belgelerin raflarını kızıla boyaması, saldırının tam da o yasak bölgenin kalbinde gerçekleştiğini mühürledi.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c2",
        text: "Kafatasındaki derin, pürüzsüz ve son derece geniş göçük, ancak binlerce sayfalık, ciltli ve devasa bir bilgi yığınının ölümcül bir güçle savrulmasıyla açıklanabilirdi.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c3",
        text: "Otuz yıllık emektar kütüphanecinin elektronik yaka kartı, cinayet saatinden çok önce ana kapı turnikelerinden geçerek binayı terk ettiğini sisteme kazımıştı.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c4",
        text: "Temizlik görevlisinin deterjan arabasındaki tekerlek izleri ve log kayıtları, onun gece yarısı sadece arşiv dosyalarının tutulduğu o dar ve soğuk odayı temizlediğini kanıtladı.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c5",
        text: "Kayıp el yazmalarını haftalardır takıntılı bir şekilde araştıran akademisyenin masasında, her zaman açık duran o iki kilogramlık devasa ansiklopedik referans cildi yerinde yoktu.",
        type: "forensic",
        isBonus: true,
      },
      {
        id: "c6",
        text: "Gece nöbetçisinin feneri, paha biçilmez el yazmalarının saklandığı koridorun hemen çıkışında, doktora öğrencisinin soluk soluğa uzaklaşan silüetini yakalamıştı.",
        type: "witness",
        isBonus: true,
      },
    ],
  ...
  },
  {
    ...
    clues: [
      ...
      {
        id: "c1",
        text: "Kurbanın parçalanmış kafatası ve yaradaki paslı demir oksit kalıntıları, ölümün narin bir mühendislik harikasından değil, kaba kuvvetle savrulan çok ağır bir maden kütlesinden geldiğini gösteriyordu.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c2",
        text: "Kırılmış dişliler, devrilmiş ağır sanayi tezgahları ve etrafa saçılan yoğun makine yağı, boğuşmanın tam da üretimin gerçekleştiği o gürültülü ve yağlı atölye merkezinde yaşandığını kanıtlıyordu.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c3",
        text: "Muhasebe müdürünün o akşamki uçağına ait biniş kartı ve havaalanı güvenlik görüntüleri, onu bu metal cehenneminden millerce uzağa yerleştirmişti.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c4",
        text: "Makine mühendisinin parmak izleri ve retinal erişim kayıtları, onun tüm gece boyunca izole ve elektronik panellerle çevrili soğuk sunucu odasında kod yazdığını mühürledi.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c5",
        text: "İşçilerin kulaklarını sağır eden o siren çalmadan hemen önce, fabrika müdürü ile sendika temsilcisinin gürültülü üretim bandının hemen yanında hararetli bir kavgaya tutuştukları ortaya çıktı.",
        type: "forensic",
        isBonus: true,
      },
      {
        id: "c6",
        text: "Yere dökülen siyah makine yağının tam ortasında yatan o ağır ve küt uçlu demir çekicin sapında, işçi başının nasırlı ellerine ait taze epitel dokular parlıyordu.",
        type: "witness",
        isBonus: true,
      },
    ],
  ...
  },
  {
    ...
    clues: [
      {
        id: "c1",
        text: "Hastaneden gelen acil toksikoloji raporunda kurbanın midesindeki şiddetli ve anlık asit reaksiyonu, ölümün doğrudan yudumlanan koyu renkli bir içecekten geldiğini belgeliyordu.",
        type: "forensic",
        isBonus: false,
      },
      {
        id: "c2",
        text: "Masaya devrilen iskemle ve yere saçılan porselen kırıkları, kurbanın son nefesini esintili bir terasta değil, tam da oturduğu o bohem iç mekanın kalbinde verdiğini gösterdi.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c3",
        text: "Kafe sahibinin üzerindeki yoğun kasa fişi mürekkebi ve kamera açısı, onun tüm kaosu sadece uzaktan, tezgahın arkasından izlediğini doğruladı.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c4",
        text: "Bitişik masada oturan müşterinin pardösüsündeki sokak tozu ve dış mekan kamerasındaki kesintisiz silüeti, onun açık hava terasından bir saniye bile içeri adım atmadığını teyit etti.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c5",
        text: "Kurbanın önündeki o özel demliğe mutfaktayken tek dokunan ve onu masaya kadar kimsenin yaklaşmasına izin vermeden getiren kişi, o gün işe başlayan sessiz görevliydi.",
        type: "direct",
        isBonus: true,
      },
      {
        id: "c6",
        text: "Genç garsonun önlüğünün sol cebinde bulunan o minik ve boş cam şişedeki son damla, kurbanın demliğinden alınan numunedeki ölümcül zehirle birebir aynı kimyasal imzayı taşıyordu.",
        type: "evidence",
        isBonus: true,
      },
    ],
  ...
  },
  {
    ...
    clues: [
      {
        id: "c1",
        text: "Kurbanın omurgasındaki devasa kırıklar ve zemindeki çarpma ivmesi, bedenin hiçbir silahla dövülmediğini; yalnızca yerçekiminin o acımasız ve yüksekten düşürücü gücüne maruz kaldığını gösteriyordu.",
        type: "forensic",
        isBonus: false,
      },
      {
        id: "c2",
        text: "Tarihi taşların üzerindeki kan sıçramaları ve kopan ceket düğmeleri, arbedenin kapalı odalarda değil, İstanbul'u kuşbakışı gören o rüzgarlı ve açık seyir terasının dondurucu korkuluklarında yaşandığını mühürledi.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c3",
        text: "Turist Nilgün'ün panik atak ilaçları ve tünel girişindeki kafenin adisyonu, onun yükseklik korkusu yüzünden kulenin basamaklarına adım dahi atmadığını ispatladı.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c4",
        text: "Tur rehberinin telsiz kayıtları ve gruptaki otuz kişinin yeminli beyanı, onun o kritik dakikalarda zemin kattaki teknik odada kayıp bir turisti aradığını kesinleştirdi.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c5",
        text: "O fırtınalı saatte seyir terasına açılan ve ağır asma kilitlerle korunan o demir kapıyı açabilecek tek anahtar, yalnızca vardiyadaki güvenlik personelinin kemerinde takılıydı.",
        type: "direct",
        isBonus: true,
      },
      {
        id: "c6",
        text: "Maktulün boşluğa bırakıldığı o son korkuluk demirinin hemen altında, kule bekçisinin üniformasına ait kopmuş bir apolet parçası ve taze çamurlu bot izleri parlıyordu.",
        type: "forensic",
        isBonus: true,
      },
    ],
  ...
  },
  {
    ...
    clues: [
      {
        id: "c1",
        text: "Kurbanın kafatasındaki o geniş, beyaz tozlar bırakan ve kemiği un ufak eden devasa yara, sanat eseri ağırlığındaki küt bir taş veya mermer bloğun ölümcül darbesini fısıldıyordu.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c2",
        text: "Olay yerindeki kırık antika vazolar ve havada asılı kalan asırlık toz bulutu, cinayetin pasajın ışıklı koridorlarında değil, antikacının o penceresiz ve nefes kesici arka deposunda işlendiğini kanıtladı.",
        type: "evidence",
        isBonus: false,
      },
      {
        id: "c3",
        text: "Avukat Suna Çakır'ın telefon sinyalleri ve çatı restoranındaki güvenlik kameraları, onun pasajın en üst katında, Boğaz'a karşı kadeh kaldırdığını mühürledi.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c4",
        text: "Manav Talip Uzun'un ellerindeki taze meyve lekeleri ve komşu esnafın beyanları, onun giriş kapısındaki sergisinden bir an olsun ayrılıp o karanlık depoya inmediğini doğruladı.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c5",
        text: "Milyonluk antika koleksiyonunun saklandığı o penceresiz arka deponun karmaşık yerleşim planını ve devasa asma kilidinin şifresini sadece mekanın kendi efendisi biliyordu.",
        type: "direct",
        isBonus: true,
      },
      {
        id: "c6",
        text: "Dükkan sahibinin şahsi envanterinde 'En Değerli Parçalar' arasında listelenen o devasa mermer büst kayıptı; kurbanın başucunda bulunan kaidedeki kan izleri ise Orhan Aras'ın DNA'sıyla %100 eşleşmişti.",
        type: "forensic",
        isBonus: true,
      },
    ],
  ...
  },
  {
    ...
    clues: [
      {
        id: "c1",
        text: "Adli toksikoloji raporu, kurbanın midesindeki alkolün içine gizlenmiş, kasları saniyeler içinde felç eden ve kalp krizini taklit eden o sinsi sıvının kimyasal haritasını çıkardı.",
        type: "forensic",
        isBonus: false,
      },
      {
        id: "c2",
        text: "Masaya devrilen meze tabakları, rakı kadehleri ve duvara sinen ağır anason kokusu, ölümün açık havadaki teknelerde değil, tam da o tarihi meyhanenin sıcak iç salonunda geldiğini doğruladı.",
        type: "evidence",
        isBonus: false,
      },
      {
      ...
      {
        id: "c4",
        text: "Mahalle doktoru Taner'in hastane acil servisindeki imza logları ve nöbetçi çizelgesi, onun meyhane kapısından içeri adım bile atmadığını kesinleştirdi.",
        type: "witness",
        isBonus: false,
      },
      {
        id: "c5",
        text: "Maktulün masasında duran ve özel bir tasarıma sahip olan o şişe, yalnızca meyhane sahibesinin şahsi anahtarıyla açılabilen o antika ahşap vitrinin baş köşesine aitti.",
        type: "direct",
        isBonus: true,
      },
      {
        id: "c6",
        text: "Zehirli rakı şişesinin tıpasında, sadece meyhane sahibesi Esma Hanım'ın o gece ellerine sürdüğü o nadide gül yağlı kremin mikroskobik doku kalıntıları bulundu.",
        type: "evidence",
        isBonus: true,
      },
    ],
