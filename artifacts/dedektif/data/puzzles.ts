...
export const PUZZLES: Puzzle[] = [
  {
    ...
    "difficulty": "caylak",
    "dayIndex": 1,
    "story": "Tarihi konaktaki gece davetinin ardından ev sahibinin sadık yardımcısı Selma, kan içinde bulundu. Adli tıp, cinayetin 23:30 ile 00:00 arasında işlendiğini tahmin ediyor. Fırtına nedeniyle kimsenin ayrılamadığı bu konakta, katil hala aramızda.",
    "suspects": [
      {
        "id": "s1",
        "name": "Nazik Hanım",
        "description": "Konağın en yaşlı misafiri. Fiziksel olarak güçsüz olsa da etrafında olan bitene karşı son derece dikkatli ve gözlemci.",
        "icon": "pa:konakta_s1"
      },
      {
        "id": "s2",
        "name": "Cem Bey",
        "description": "Ev sahibinin uzaktan akrabası. Boylu poslu, ağır fiziksel işleri kolayca yapabilecek kuvvette bir yapıya sahip.",
        "icon": "pa:konakta_s2"
      },
      {
        "id": "s3",
        "name": "Zeynep Hanım",
        "description": "Genç ve hırslı bir davetli. Atik yapısıyla dikkat çekiyor, stres altında çok hızlı ve fevri hareket edebiliyor.",
        "icon": "pa:konakta_s3"
      }
    ],
    "weapons": [
      {
        "id": "w1",
        "name": "Makas",
        "description": "Et ve kemik parçalamak için tasarlanmış, tek hamlede derin yara açabilen ağır ve keskin mutfak aleti.",
        "icon": "pa:konakta_w1"
      },
      {
        "id": "w2",
        "name": "Kimyasal",
        "description": "Renksiz ve kokusuz bir endüstriyel çözücü. Yiyecek veya içeceklere karıştırıldığında fark edilmesi imkansız.",
        "icon": "pa:konakta_w2"
      },
      {
        "id": "w3",
        "name": "İp",
        "description": "Ağır perdeleri ve dekorasyonları asmak için kullanılan, kalın ve oldukça sağlam kenevir halat.",
        "icon": "pa:konakta_w3"
      }
    ],
    "locations": [
      {
        "id": "l1",
        "name": "Kütüphane",
        "description": "Kalın duvarları ve ağır meşe kapısı sayesinde dışarıya veya içeriye hiçbir sesin sızmadığı izole çalışma alanı.",
        "icon": "pa:konakta_l1"
      },
      {
        "id": "l2",
        "name": "Bahçe",
        "description": "Konağın etrafını saran açık alan. Loş aydınlatması sayesinde kuytu köşelerde rahatça gizlenme imkanı sunuyor.",
        "icon": "pa:konakta_l2"
      },
      {
        "id": "l3",
        "name": "Mutfak",
        "description": "Yerleri genellikle nemli ve kaygan olan, içinde onlarca tehlikeli aletin bulunduğu arka cephedeki hazırlık alanı.",
        "icon": "pa:konakta_l3"
      }
    ],
    "clues": [
      {
        "id": "c1",
        "text": "Kurban zehirlenmemiş veya iple boğulmamış; derin bir kesici alet darbesiyle hayatını kaybetmiş.",
        "type": "forensic",
        "isBonus": false
      },
      {
        "id": "c2",
        "text": "Nazik Hanım gece boyunca Bahçe'de çayını yudumlayarak kitap okuduğunu belirtti ve bu durum doğrulandı.",
        "type": "witness",
        "isBonus": false
      },
      {
        "id": "c3",
        "text": "Cem Bey'in gece boyunca Kütüphane'den çıkmadığı ve dekorasyonlarla uğraştığı rapor edildi.",
        "type": "witness",
        "isBonus": false
      },
      {
        "id": "c4",
        "text": "Kan izleri ve boğuşma kanıtları yalnızca arkadaki hazırlık alanında bulunuyor.",
        "type": "evidence",
        "isBonus": false
      },
      {
        "id": "c5",
        "text": "Koridor kameraları, Zeynep Hanım'ın 23:38'de Mutfağa giriş yaptığını ve 00:15'te telaşla çıktığını gösteriyor.",
        "type": "record",
        "isBonus": true
      },
      {
        "id": "c6",
        "text": "Ağır mutfak makasının sap kısmında, Zeynep Hanım'a ait net parmak izleri tespit edildi.",
        "type": "forensic",
        "isBonus": true
      }
    ],
  ...
  },
  {
    ...
    suspects: [
      { id: "s1", name: "Tüccar Kadın Safiye Hanım", description: "Rize'ye mal götüren yaşlı kadın tüccar; Ahmet Bey'in geç kaldığı için kendisini zor durumda bıraktığını söylüyor.", icon: "pa:dag_s1" },
      { id: "s2", name: "Öğretmen Adayı Levent", description: "Atama için Rize'ye giden genç öğretmen adayı; yanında tayin belgeleri var.", icon: "pa:dag_s2" },
      { id: "s3", name: "Orman İşçisi Bayram", description: "Orman bölgesinden dönen deneyimli orman işçisi; yanında kesici aletler taşıyan büyük bir çanta var.", icon: "pa:dag_s3" },
    ],
    weapons: [
      { id: "w1", name: "Orman Bıçağı", description: "Ağaç budama ve kesme işleri için kullanılan büyük, ağır orman bıçağı.", icon: "pa:dag_w1" },
      { id: "w2", name: "Taş", description: "Yol kenarındaki duvarda gevşek duran sivri köşeli büyük taş.", icon: "pa:dag_w2" },
      { id: "w3", name: "Demir Levye", description: "Minibüsün araç gereç bölümündeki demir levye.", icon: "pa:dag_w3" },
    ],
    locations: [
      { id: "l1", name: "Yol Kenarı", description: "Minibüsün durduğu noktanın hemen yanındaki taş duvarlı yol kenarı.", icon: "pa:dag_l1" },
      { id: "l2", name: "Orman İçi", description: "Yolun solundaki sık çam ormanı; görüş mesafesi çok kısa.", icon: "pa:dag_l2" },
      { id: "l3", name: "Minibüs İçi", description: "Yolculuk minibüsünün iç kabini.", icon: "pa:dag_l3" },
    ],
    clues: [
  ...
  },
  {
    ...
    suspects: [
      { id: "s1", name: "Hacı Efendi Rüstem", description: "Hac dönüşü Konya'ya uğrayan yaşlı tüccar; Lütfi Bey'den yıllar önce borç almış ama geri ödememiş.", icon: "pa:ramazan_s1" },
      { id: "s2", name: "Genç Mühendis Adnan", description: "Konya'ya iş için gelen altyapı mühendisi; Lütfi Bey'in otelini yıkımdan kurtarma talebini reddetmiş.", icon: "pa:ramazan_s2" },
      { id: "s3", name: "Dul Kadın Zümrüt Hanım", description: "Konya'ya akraba ziyaretine gelen dul; Lütfi Bey'in kendisine yönelik taciz girişimini yaşadığını söylüyor.", icon: "pa:ramazan_s3" },
    ],
    weapons: [
      { id: "w1", name: "Şam Bıçağı", description: "İnce, uzun ve her iki tarafı keskin süslü Şam bıçağı.", icon: "pa:ramazan_w1" },
      { id: "w2", name: "Kandil Direği", description: "Koridorda asılı kandillerden birinin ağır pirinç direği.", icon: "pa:ramazan_w2" },
      { id: "w3", name: "Halat", description: "Han çatı katında bulunan kalın sarma halat.", icon: "pa:ramazan_w3" },
    ],
    locations: [
      { id: "l1", name: "Koridor", description: "Odaların önündeki loş kandil ışıklı uzun koridor.", icon: "pa:ramazan_l1" },
      { id: "l2", name: "Avlu", description: "Hanın ortasındaki açık avlu; gece boyunca bekçi dolaşıyor.", icon: "pa:ramazan_l2" },
      { id: "l3", name: "Çatı Katı", description: "Han eşyalarının depolandığı üst çatı katı.", icon: "pa:ramazan_l3" },
    ],
    clues: [
  ...
  },
  {
    ...
    suspects: [
      { id: "s1", name: "Baş Soprano", description: "Gösterinin yıldızı. Narsist, sesiyle herkesi büyüleyen ancak kuliste herkesle kavgalı olan başrol.", icon: "pa:senfoni_s1" },
      { id: "s2", name: "Orkestra Şefi", description: "Disiplinli ve katı. Müzikal mükemmellik için her şeyi yapabilecek takıntılı bir otorite.", icon: "pa:senfoni_s2" },
      { id: "s3", name: "Işık Teknisyeni", description: "Tavan arasındaki loş odalarda çalışan, sistemleri yöneten sessiz teknik personel.", icon: "pa:senfoni_s3" },
      { id: "s4", name: "Eski Aktör", description: "Yıllar önce sahnelerden men edilen, tiyatro hilelerini ve sahne arkasını avucunun içi gibi bilen kin dolu oyuncu.", icon: "pa:senfoni_s4" },
    ],
    weapons: [
      { id: "w1", name: "Tiyatro Hançeri", description: "Sahnede kullanılan ancak ucu sonradan keskinleştirilmiş dekoratif bıçak.", icon: "pa:senfoni_w1" },
      { id: "w2", name: "Zehirli Çiçek", description: "Tebrik için gönderilen, koklandığında solunum yollarını felç eden nadir bir botanik zehir.", icon: "pa:senfoni_w2" },
      { id: "w3", name: "Piyano Teli", description: "Son derece ince, görünmez ve boyna dolandığında kemiğe kadar kesen çelik tel.", icon: "pa:senfoni_w3" },
      { id: "w4", name: "Kum Torbası", description: "Sahne dekorlarını dengeleyen, yüksekten düşürüldüğünde anında ezerek öldüren devasa ağırlık.", icon: "pa:senfoni_w4" },
    ],
    locations: [
      { id: "l1", name: "Ana Sahne", description: "Binlerce kişinin izlediği, aydınlık, devasa performans alanı.", icon: "pa:senfoni_l1" },
      { id: "l2", name: "Orkestra Çukuru", description: "Müzisyenlerin sıkışık halde çaldığı, sahnenin hemen altındaki dar platform.", icon: "pa:senfoni_l2" },
      { id: "l3", name: "Soyunma Odası", description: "Oyuncuların hazırlandığı, aynalarla kaplı, kapısı kilitlenebilen özel kulis odası.", icon: "pa:senfoni_l3" },
      { id: "l4", name: "Tavan Arası", description: "Sadece teknisyenlerin çıktığı, makaraların ve kabloların olduğu karanlık üst alan.", icon: "pa:senfoni_l4" },
    ],
    clues: [
  ...
  },
  {
    ...
    suspects: [
      { id: "s1", name: "Rakip Pilot", description: "Maktulün en büyük ticari rakibi olan, havacılık donanımlarına çok iyi hakim agresif pilot.", icon: "pa:kanli_s1" },
      { id: "s2", name: "Turist Kadın", description: "Sadece fotoğraf çekmek için orada olan, yükseklik korkusu olan sıradan bir misafir.", icon: "pa:kanli_s2" },
      { id: "s3", name: "Balon Mekanikçisi", description: "Gaz tüplerinden sorumlu, elleri sürekli yağlı ve kirli olan bakım personeli.", icon: "pa:kanli_s3" },
      { id: "s4", name: "Fotoğrafçı", description: "Turistleri karadan takip eden, sürekli kamerasıyla çekim yapan güler yüzlü çalışan.", icon: "pa:kanli_s4" },
    ],
    weapons: [
      { id: "w1", name: "İşaret Fişeği", description: "Acil durumlarda gökyüzüne sıkılan, yakından ateşlendiğinde ağır yanıklar bırakan piroteknik silah.", icon: "pa:kanli_w1" },
      { id: "w2", name: "Pürmüz Alevi", description: "Balonu şişirmek için kullanılan, insan bedenini saniyeler içinde kömüre çevirebilen devasa ateşleyici.", icon: "pa:kanli_w2" },
      { id: "w3", name: "Sabotaj Bıçağı", description: "Halatları kesmek için özel tasarlanmış, tırtıklı ve son derece keskin taktiksel bıçak.", icon: "pa:kanli_w3" },
      { id: "w4", name: "Paraşüt İpi", description: "Kopan parçaları bağlamak için bulunan esnek ancak boğucu ince kordon.", icon: "pa:kanli_w4" },
    ],
    locations: [
      { id: "l1", name: "Havalanma Alanı", description: "Düzinelerce balonun aynı anda kalktığı kalabalık, düz ve açık arazi.", icon: "pa:kanli_l1" },
      { id: "l2", name: "Balon Sepeti", description: "Gökyüzünde süzülen, hareket alanının santimetrelerle ölçüldüğü dar hasır sepet.", icon: "pa:kanli_l2" },
      { id: "l3", name: "Vadi Kayalıkları", description: "Balonların alçalarak teğet geçtiği, ıssız ve sivri peri bacalarının bulunduğu arazi.", icon: "pa:kanli_l3" },
      { id: "l4", name: "Yakıt Deposu", description: "Yedek propan tüplerinin kilit altında tutulduğu, kimsenin uğramadığı küçük taş kulübe.", icon: "pa:kanli_l4" },
    ],
    clues: [
  ...
  },
  {
    ...
    suspects: [
      { id: "s1", name: "Kaptan", description: "Tekneyi yöneten, suya hiç girmeyen ve dalış teçhizatlarını kullanmayı bilmeyen denizci.", icon: "pa:derin_s1" },
      { id: "s2", name: "Asistan Arkeolog", description: "Maktulün bulgularını kendine mal etmek isteyen, hırslı ancak tüplü dalışta acemi araştırmacı.", icon: "pa:derin_s2" },
      { id: "s3", name: "Usta Dalgıç", description: "Ekibin güvenliğinden sorumlu, denizin dibinde saatlerce kalabilen ve tüm ekipmanlara hakim profesyonel.", icon: "pa:derin_s3" },
      { id: "s4", name: "Tarihçi", description: "Yaşı gereği sadece güvertede not tutan, fiziksel efor gerektiren hiçbir işe karışmayan ihtiyar.", icon: "pa:derin_s4" },
    ],
    weapons: [
      { id: "w1", name: "Zıpkın", description: "Su altında köpekbalıklarına karşı bulundurulan, fırlatıldığında vücudu delip geçen mızraklı tüfek.", icon: "pa:derin_w1" },
      { id: "w2", name: "Oksijen Kesintisi", description: "Tüplerdeki valfin gizlice kapatılarak kurbanın yavaşça ve acı çekerek boğulmasını sağlayan sinsi yöntem.", icon: "pa:derin_w2" },
      { id: "w3", name: "Deniz Bıçağı", description: "Ağlara takılmamak için dalgıçların bacağına bağladığı son derece keskin alet.", icon: "pa:derin_w3" },
      { id: "w4", name: "Ağırlık Kemeri", description: "Fazladan takıldığında kurbanı hızla dibe çeken ve yüzeye çıkmasını engelleyen kurşun bloklar.", icon: "pa:derin_w4" },
    ],
    locations: [
      { id: "l1", name: "Araştırma Teknesi", description: "Su üstündeki ana üs. Tüm personelin toplandığı geniş güverte.", icon: "pa:derin_l1" },
      { id: "l2", name: "Kaptan Köşkü", description: "Sadece tekneyi süren kişinin bulunduğu, telsiz cihazlarıyla dolu aydınlık kamara.", icon: "pa:derin_l2" },
      { id: "l3", name: "Dalış Platformu", description: "Teknenin arka kısmında, suya atlanılan ve malzemelerin giyildiği ıslak metal alan.", icon: "pa:derin_l3" },
      { id: "l4", name: "Batık İçerisi", description: "Denizin 40 metre altındaki, zifiri karanlık, klostrofobik ve ahşap enkaz alanı.", icon: "pa:derin_l4" },
    ],
    clues: [
  ...
  },
  {
    ...
    suspects: [
      { id: "s1", name: "Kıskanç Çırak", description: "Ustasının gölgesinde kalmaktan nefret eden, her yeri boya içinde genç sanat öğrencisi.", icon: "pa:tuval_s1" },
      { id: "s2", name: "Sanat Eleştirmeni", description: "Ressamın eserlerini sürekli kötüleyen, ellerini kirletmekten nefret eden titiz ve şık adam.", icon: "pa:tuval_s2" },
      { id: "s3", name: "Model", description: "Tablo için saatlerce hareketsiz poz veren, güzel ve dikkat çekici genç kadın.", icon: "pa:tuval_s3" },
      { id: "s4", name: "Galeri Sahibi", description: "Tablonun satışından milyonlar kazanacak olan, sürekli hesap kitap yapan otoriter kadın.", icon: "pa:tuval_s4" },
    ],
    weapons: [
      { id: "w1", name: "Heykeltıraş Çekici", description: "Mermer yontmak için kullanılan, kafatasına vurulduğunda anında öldüren ağır tahta tokmak.", icon: "pa:tuval_w1" },
      { id: "w2", name: "Boya Çözücü", description: "İçkisine karıştırıldığında kalp krizini tetikleyen, tiner bazlı son derece toksik şeffaf kimyasal.", icon: "pa:tuval_w2" },
      { id: "w3", name: "Palet Bıçağı", description: "Boyaları karıştırmak için kullanılan esnek ancak boğaza saplandığında ölümcül olan ince alet.", icon: "pa:tuval_w3" },
      { id: "w4", name: "Tel Çerçeve", description: "Tuvalleri asmak için kullanılan, boyna dolandığında nefesi kesen ince çelik tel.", icon: "pa:tuval_w4" },
    ],
    locations: [
      { id: "l1", name: "Ana Atölye", description: "Şövalyelerin bulunduğu, her tarafı boya kokan, bol ışıklı geniş çalışma alanı.", icon: "pa:tuval_l1" },
      { id: "l2", name: "Boya Deposu", description: "Kimyasalların ve tuvallerin istiflendiği, havalandırması olmayan kilitli loş oda.", icon: "pa:tuval_l2" },
      { id: "l3", name: "Dinlenme Odası", description: "Ressamın kahvesini içtiği, deri koltukların bulunduğu temiz ve izole arka oda.", icon: "pa:tuval_l3" },
      { id: "l4", name: "Sergi Girişi", description: "Müşterilerin karşılandığı, resepsiyon bankosunun olduğu giriş bölümü.", icon: "pa:tuval_l4" },
    ],
    clues: [
